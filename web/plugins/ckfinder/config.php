...
session_start();
//$suffix = isset($_SESSION['_managerId']) ? ($_SESSION['_managerId'] == 1 ? '' : '-'.$_SESSION['_managerId']) : '';
/*============================ PHP Error Reporting ====================================*/
...
$config['resourceTypes'][] = array(
    ...
    //'directory'         => 'files'.$suffix,
    'directory'         => 'files',
    'maxSize'           => 0,
    //'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'allowedExtensions' => 'docx, xlsx, doc',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,docx,xlsx,doc',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
