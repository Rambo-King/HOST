...
<?php foreach($products as $v): ?>
    ...
    <div class="test-ip"><?= $v['ip'] ?></div>

    <?php if(isset($v['note']) && !empty($v['note'])): ?>
        <div id="notes" class="notes"><?= $v['note'] ?></div>
    <?php endif; ?>
